...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Dhcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"dhcointools.com", "192.168.12.129"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"dhcointools.com", "testnet-seed.dhcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Dhcoin is probably already running."), addrBind.ToString().c_str());
        else
